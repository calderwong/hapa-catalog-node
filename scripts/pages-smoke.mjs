...
assert.ok(index.includes('forecast-dashboard-v4'));
...
assert.equal(data.forecast_dashboards.category.ok, true);
assert.equal(data.forecast_dashboards.brand.ok, true);
assert.equal(data.forecast_dashboards.state.ok, true);
assert.equal(data.forecast_dashboards.sku.ok, true);
